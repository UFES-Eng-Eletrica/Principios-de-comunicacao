...
% =========================================================================
%                                                                         %
% Lab 3.II - Principios Comunicações I -                                  %
%    ----------  Modulação SSB/SC por Desvio de Fase   --------------     %
%                                                                         %
% by Prof. Jair Silva                                                     %
%                                                                         %
% =========================================================================
...
Fc      = Fs/4;     % Frequencia Central da Modulação 
snr     = 20;      % Relação Sinal-Ruído
fcorte1 = 0.2;      % Primeira Freq. corte do filtro de DEMULTIPLEXAÇÃO  
fcorte2 = 0.5;     % Segunda  Freq. corte do filtro de DEMULTIPLEXAÇÃO 
...
% -- Segunda Parte: Geração do Sinal e o Correspondente defasado de 90° --
s_hil = hilbert(m1);    % Sinal Modulado
% ------------------------------------------------------------------------

% -------       Terceira Parte: Multipleação QAM        ------------------
...
% ------------- Quarta Parte - Demultiplexação QAM   ----------------------
