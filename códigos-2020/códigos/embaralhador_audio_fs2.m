...
x = x(1:tam);    % Corte no tempo desejado
...
% Reamostrando sinal
x = resample(x,2,1); % Taxa 2x maior
Fs = Fs*2;           % Taxa 2x maior
ts = 1/Fs;           % Período de Amostragem (s)
tam = tam*2;         % Quantidade de Amostras 2x maior
