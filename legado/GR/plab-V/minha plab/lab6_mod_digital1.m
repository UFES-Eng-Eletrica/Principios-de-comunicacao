...
k = log2(M); % bits por símbolo = log2(M)=1
...
%
% Gera o Bitstream
x = randi([0 M-1], 1, n ); %0 a M-1 é o númerode bits por inteiro lido
% Modulação
if tp == 0
 % Modulação (M-PAM)
...
% é preciso comentar os gráficos
hold on
%plot(real(y_ruido(1:nsamp*50)),'r') % plota o sinal ruidoso. para n
%=3milhões é preciso comentar os gráficos

% Mostra o diagram de olho na saída do canal
%para fazer para n=1milhão ,devemos comentar tudo abaixo
%if nsamp == 1
 %offset = 0;
...
%scatterplot(y_down) %é preciso manter a distÂncia euclidiana para
%diferentes valores de M(a distância é sempre 2)
...
............... Modulação Digital .................................
%SNR: 25.0 dB
%BER: 0.0e+000; voz -> e-03; dado/áudio -> e-06 ; fibra ótica -> e-12
%Qtd de erros: 0
...................................................................