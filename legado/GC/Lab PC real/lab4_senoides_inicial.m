...
Fc1     = 0.2e6;    % Frequencia de opera��o do primeiro sinal 
Fc2     = 0.3e6;    % Frequencia de opera��o do segundo sinal
Fc3     = 0.4e6;   % Frequencia de opera��o do terceiro sinal
snr     = 100;      % Rela��o Sinal-Ru�do
fcorte1 = 0.2;      % Primeira Freq. corte do filtro de DEMULTIPLEXA��O  
fcorte2 = 0.43;     % Segunda  Freq. corte do filtro de DEMULTIPLEXA��O 
ordem   = 40;       %Ordem do filtro passa faixa de recep��o(ligado ao fator de qualidade)
% =========================================================================
...
h = fir1(ordem,[fcorte1 fcorte2]);            % Cria o filtro passa banda, que pode ser
%alterado para acharmos ou o primeiro, ou o segund ou o terceiro sinal              
...
m_demod = ssbdemod(sinal_demux,Fc1,Fs);   % Modula o segundo sinal
% ------------------------------------------------------------------------
